...
function App() {
  ...
  const [desktopAttached, setDesktopAttached] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "widget-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "widget-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "widget-header draggable", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: formatDate(snapshot.today) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "quick-form no-drag", onSubmit: addTodo, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "添加" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "summary-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: remainingLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => window.todoApi.openAddTodo(), children: "快捷添加" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "todo-list", "aria-label": "今日待办", children: snapshot.activeTodos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: todo.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-button danger", type: "button", onClick: () => window.todoApi.deleteTodo(todo.id), children: "删除" })
    ] }, todo.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "completed-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-title", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "今天完成" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: snapshot.completedToday.length })
      ] }),
...
function AddTodoWindow() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "quick-add-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "quick-add-card", onSubmit: submit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "quick-add-header draggable", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "快捷添加" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "新的待办事项" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "icon-button no-drag", type: "button", onClick: () => window.todoApi.closeCurrentWindow(), children: "关闭" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
...
function CalendarView() {
  ...
  const [selectedDate, setSelectedDate] = reactExports.useState(() => toDateKey(/* @__PURE__ */ new Date()));
  ...
  const dayMap = reactExports.useMemo(() => new Map(days.map((day) => [day.date, day])), [days]);
  const cells = reactExports.useMemo(() => getMonthCells(currentMonth), [currentMonth]);
  const selected = dayMap.get(selectedDate);
  const changeMonth = (offset) => {
    setCurrentMonth((date) => new Date(date.getFullYear(), date.getMonth() + offset, 1));
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "calendar-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "calendar-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "calendar-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "完成记录" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "calendar-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => changeMonth(-1), children: "上个月" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setCurrentMonth(/* @__PURE__ */ new Date()), children: "今天" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => changeMonth(1), children: "下个月" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "calendar-layout", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "calendar-grid", "aria-label": "完成事项日历", children: [
        weekDays.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "weekday", children: day }, day)),
        cells.map((date) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                data ? /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: data.completedCount }) : null
              ]
            },
            dateKey
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "day-detail", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: selectedDate }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "完成事项" }),
        !selected || selected.completedTodos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "没有完成记录" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "完成今日待办后会出现在这里。" })
        ] }) : selected.completedTodos.map((todo) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "detail-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: todo.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => window.todoApi.reopenTodo(todo.id), children: "恢复" })
        ] }, todo.id))
      ] })
    ] })
  ] }) });
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(View, {}) })
);
